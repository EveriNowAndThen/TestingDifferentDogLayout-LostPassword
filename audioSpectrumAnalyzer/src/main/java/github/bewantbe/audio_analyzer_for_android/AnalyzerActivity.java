...
AnalyzerActivity extends Activity          // AnalyzerActivity is directly linked to AnalyzerGraphic.Readyghbnnn
        ...
        OnItemClickListener, AnalyzerGraphic.Ready
{
    ...
    public void onBackPressed(){
        toDogActivity.dogEdit.putBoolean("firstConnect", true);
